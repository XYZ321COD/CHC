...
def get_transforms(name, args):
    train_transforms = {
        ...
        'imagenettiny': transforms.Compose([
                        transforms.RandomResizedCrop(224 if args.cc_data else 64),
                        transforms.RandomHorizontalFlip(p=0.5),
                        transforms.RandomApply([transforms.ColorJitter(0.4, 0.4, 0.4, 0.1)], p=0.8),
                        transforms.RandomGrayscale(p=0.2),
                        transforms.ToTensor(),
    ...
    valid_transforms = {
        ...
        'imagenetdogs': transforms.Compose([
                        ...
                        transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])]),
        'imagenettiny': transforms.Compose([
                        transforms.Resize(224 if args.cc_data else 64),
                        transforms.ToTensor(),
                        transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])]),
        'mnist': transforms.Compose([
...
def get_contrastive_dataset(name, args):
    train_data = {
        ...
        'imagenettiny':  ImageFolderPair(root='/shared/sets/datasets/tiny-imagenet-200/train', transform=get_transforms('imagenettiny', args)[0]),
    ...
    test_data = {
        ...
        'imagenettiny':  ImageFolderPair(root='/shared/sets/datasets/tiny-imagenet-200/val', transform=get_transforms('imagenettiny', args)[1]),
    ...
    memory_data = {
        ...
        'imagenettiny':  ImageFolderPair(root='/shared/sets/datasets/tiny-imagenet-200/train', transform=get_transforms('imagenettiny', args)[1]),
...
class ImageFolderPair(torchvision.datasets.ImageFolder):
